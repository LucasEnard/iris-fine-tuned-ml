...
tokenizer = AutoTokenizer.from_pretrained("/irisdev/app/src/model/bert-base-cased",model_max_length=512)
...
### MODEL AND METRCIS
model = AutoModelForSequenceClassification.from_pretrained("/irisdev/app/src/model/bert-base-cased",num_labels=5)
...
# print()
# print("saving model")
# trainer.save_model("/irisdev/app/src/model/temp")